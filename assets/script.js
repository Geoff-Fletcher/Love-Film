const quizzes = {
    easy: {
        ...
        "Horror": [ 
            { question: "What is the name of the killer doll in the *Child's Play* series?", choices: ["Annabelle", "Billy", "Chucky", "Slappy"], answer: "Chucky", genre: "Horror" },
            { question: "In the *Scream* franchise, what is the nickname given to the killer?", choices: ["Ghostface", "The Slasher", "The Mask", "The Phantom"], answer: "Ghostface", genre: "Horror" },
            { question: "Who directed the 1979 horror classic *Alien*?", choices: ["James Cameron", "Ridley Scott", "John Carpenter", "George Romero"], answer: "Ridley Scott", genre: "Horror" }, 
            { question: "Which horror movie features a terrifying creature called 'The Creeper'?", choices: ["Jeepers Creepers", "The Descent", "The Babadook", "Sinister"], answer: "Jeepers Creepers", genre: "Horror" }, 
            { question: "What is the name of the main antagonist in the *Hellraiser* series?", choices: ["Leatherface", "Pinhead", "The Engineer", "Candyman"], answer: "Pinhead", genre: "Horror" }, 
            { question: "In *A Nightmare on Elm Street*, what weapon does Freddy Krueger use?", choices: ["Chainsaw", "Knife glove", "Axe", "Machete"], answer: "Knife glove", genre: "Horror" }, 
            { question: "Who is the director of the classic horror film *Psycho*?", choices: ["Stanley Kubrick", "Alfred Hitchcock", "George Romero", "John Carpenter"], answer: "Alfred Hitchcock", genre: "Horror" }, 
            { question: "Which 1982 horror film revolves around a malevolent force in a suburban home?", choices: ["Poltergeist", "The Amityville Horror", "The Omen", "The Exorcist"], answer: "Poltergeist", genre: "Horror" }, 
            { question: "In *A Nightmare on Elm Street*, how does Freddy Krueger attack his victims?", choices: ["With a cursed object", "Through mirrors", "In their dreams", "While they are awake"], answer: "In their dreams", genre: "Horror" }, 
            { question: "Which movie popularized the found-footage horror subgenre?", choices: ["Paranormal Activity", "The Blair Witch Project", "Cloverfield", "REC"], answer: "The Blair Witch Project", genre: "Horror" } 
        ],
    ...
    "Romance":[
        ...
        { question: "What is the name of the enchanted castle's servant in Beauty and the Beast who turns into a candelabra?", choices: ["Cogsworth", "Lumière", "Maurice", "LeFou"], answer: "Lumière", genre: "Romance" },
        { question: "In Moulin Rouge!, what is the profession of Ewan McGregors character Christian?", choices: ["Singer", "Poet", "Playwright", "Composer"], answer: "Poet", genre: "Romance" },
        ...
        { question: "In Notting Hill, what is the occupation of Hugh Grants character?", choices: ["Bookstore owner", "Lawyer", "Artist", "Journalist"], answer: "Bookstore owner", genre: "Romance" },
        { question: "In The Time Travelers Wife, what is Henry's unique ability?", choices: ["He can time travel", "He can see the future", "He can stop time", "He can teleport"], answer: "He can time travel", genre: "Romance" },
        ],
    ...
    medium: {
        ...
        "Horror": [
             { question: "Which horror movie features a cursed videotape that causes viewers to die in seven days?", choices: ["The Grudge", "Insidious", "Sinister", "The Ring"], answer: "The Ring", genre: "Horror" }, 
             { question: "What type of creature is featured in the 1982 movie *The Thing*?", choices: ["Vampire", "Alien", "Zombie", "Werewolf"], answer: "Alien", genre: "Horror" }, 
             { question: "What is the name of the hotel in *The Shining*?", choices: ["The Shadow Hotel", "The Stanley Hotel", "The Grand Hotel", "The Overlook Hotel"], answer: "The Overlook Hotel", genre: "Horror" }, 
             { question: "What is the name of the family targeted by paranormal entities in *The Conjuring*?", choices: ["The Perrons", "The Warrens", "The Hodgsons", "The Lutzes"], answer: "The Perrons", genre: "Horror" }, 
             { question: "Which classic horror film was the first to show a flushing toilet on screen?", choices: ["Rosemary's Baby", "Night of the Living Dead", "Psycho", "The Haunting"], answer: "Psycho", genre: "Horror" }, 
             { question: "Which Stephen King story involves a killer clown named Pennywise?", choices: ["The Shining", "Carrie", "It", "Misery"], answer: "It", genre: "Horror" }, 
             { question: "What is the name of the book that unleashes evil in *The Evil Dead* series?", choices: ["The Dark Grimoire", "The Book of Shadows", "Necronomicon Ex-Mortis", "The Black Codex"], answer: "Necronomicon Ex-Mortis", genre: "Horror" }, 
             { question: "Which 2018 horror film features the tethered doppelgängers of a family?", choices: ["Get Out", "Midsommar", "Us", "Hereditary"], answer: "Us", genre: "Horror" }, 
             { question: "In *Friday the 13th*, what is the name of the camp where the killings take place?", choices: ["Camp Silver Lake", "Camp Redwood", "Camp Bloodwood", "Camp Crystal Lake"], answer: "Camp Crystal Lake", genre: "Horror" }, 
             { question: "What year was the original *Halloween* film released?", choices: ["1976", "1980", "1978", "1981"], answer: "1978", genre: "Horror" }, 
             { question: "What is the name of the possessed doll in *The Conjuring* universe?", choices: ["Chucky", "Billy", "Annabelle", "Lilly"], answer: "Annabelle", genre: "Horror" }, 
             { question: "What is the name of the evil clown in *Stephen King's IT*?", choices: ["Bozo", "Pennywise", "Jingles", "Laughing Jack"], answer: "Pennywise", genre: "Horror" }, 
             { question: "Which horror movie features a blind man who hunts intruders in his home?", choices: ["Hush", "Don't Breathe", "Lights Out", "The Collector"], answer: "Don't Breathe", genre: "Horror" }, 
             { question: "In *The Witch*, what animal is associated with the devil?", choices: ["A cat", "A goat", "A crow", "A wolf"], answer: "A goat", genre: "Horror" }, 
             { question: "Which horror movie features a family haunted by 'The Tethered'?", choices: ["Get Out", "The Conjuring", "Us", "Sinister"], answer: "Us", genre: "Horror" }, 
             { question: "In *The Cabin in the Woods*, which organization controls the events?", choices: ["The Syndicate", "The Agency", "The Facility", "The Corporation"], answer: "The Facility", genre: "Horror" }, 
             { question: "What is the name of the cursed camera in *Shutter*?", choices: ["Polaroid SX-70", "Kodak 35", "Rollei Magic", "It is never named"], answer: "It is never named", genre: "Horror" }, 
             { question: "Which horror movie features a son who falls victim to a cult while studying abroad?", choices: ["Midsommar", "The Wicker Man", "Rosemary's Baby", "Hereditary"], answer: "Midsommar", genre: "Horror" } 
            ],
        ...
        "Romance":[
            ...
            { question: "In The Proposal, what is the nationality of Sandra Bullock’s character Margaret?", choices: ["Canadian", "American", "British", "Australian"], answer: "Canadian", genre: "Romance" },
            ...
            { question: "In Breakfast at Tiffany’s, what is Holly Golightly's real name?", choices: ["Holly Golightly", "Lula Mae Barnes", "Daisy Fay", "Marianne Sherman"], answer: "Lula Mae Barnes", genre: "Romance" },
            ],   
    ...
    hard: {
        ...
        "Horror": [
             { question: "What is the name of the demon that possesses Regan MacNeil in *The Exorcist*?", choices: ["Pazuzu", "Azazel", "Beelzebub", "Zozo"], answer: "Pazuzu", genre: "Horror" }, 
             { question: "In *Stephen King's IT*, what is Pennywise's true form referred to as?", choices: ["The Deadlights", "The Beast", "The Void", "The Eternal"], answer: "The Deadlights", genre: "Horror" }, 
             { question: "What mask does Michael Myers wear in the *Halloween* series?", choices: ["A clown mask", "A William Shatner mask", "A zombie mask", "A ghost face mask"], answer: "A William Shatner mask", genre: "Horror" }, 
             { question: "What was the original name of the demon in the *Insidious* series?", choices: ["The Red Demon", "The Lipstick-Face Demon", "The Fire Demon", "The Black Ghost"], answer: "The Lipstick-Face Demon", genre: "Horror" }, 
             { question: "In the 1979 movie *Alien*, what is the name of the spaceship?", choices: ["Prometheus", "Serenity", "Event Horizon", "Nostromo"], answer: "Nostromo", genre: "Horror" }, 
             { question: "In *The Blair Witch Project*, what state is the film set in?", choices: ["Maine", "West Virginia", "Maryland", "Pennsylvania"], answer: "Maryland", genre: "Horror" }, 
             { question: "What is the name of the demon in *Hereditary*?", choices: ["Paimon", "Abaddon", "Belial", "Azazel"], answer: "Paimon", genre: "Horror" }, 
             { question: "What is the name of the iconic haunted house in *The Amityville Horror*?", choices: ["221 Baker Street", "13 Elm Street", "112 Ocean Avenue", "666 Shadow Lane"], answer: "112 Ocean Avenue", genre: "Horror" }, 
             { question: "Which horror film features the quote 'We all float down here'?", choices: ["Carrie", "It", "The Shining", "The Exorcist"], answer: "It", genre: "Horror" }, 
             { question: "In *Hereditary*, what symbol is associated with the cult and Paimon?", choices: ["A dove", "A sunburst crown", "An inverted triangle", "A skull"], answer: "An inverted triangle", genre: "Horror" }, 
             { question: "What is the name of the town where *The Fog* is set?", choices: ["Crystal Lake", "Antonio Bay", "Haddonfield", "Derry"], answer: "Antonio Bay", genre: "Horror" } 
            ],
        ...
        "Sci-fi": [
            ...
            { question: "What is the main characters name in *Edge of Tomorrow*, played by Tom Cruise?", choices: ["William Cage", "John Anderton", "Jack Harper", "David Webb"], answer: "William Cage", genre: "Sci-Fi" },
        ...
        "Romance":[
            ...
            { question: "In Me Before You, what is Will Traynors profession before his accident?", choices: ["Doctor", "Lawyer", "Banker", "Architect"], answer: "Banker", genre: "Romance" },
            ...
            { question: "In Youve Got Mail, what profession does Meg Ryans character Kathleen Kelly have?", choices: ["Bookstore owner", "Journalist", "Librarian", "Florist"], answer: "Bookstore owner", genre: "Romance" },
            { question: "In While You Were Sleeping, what does Sandra Bullock's character save Peter Gallagher’s character from?", choices: ["A mugging", "Falling onto subway tracks", "A car accident", "A fire"], answer: "Falling onto subway tracks", genre: "Romance" },
            { question: "In The Holiday, where does Kate Winslets character Iris stay during the home exchange?", choices: ["Los Angeles", "New York", "Paris", "Tokyo"], answer: "Los Angeles", genre: "Romance" },
